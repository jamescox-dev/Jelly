...
public static class Keywords
{
    ...
    public static readonly StringValue Dict = new StringValue("dict");
    public static readonly StringValue Else = new StringValue("else");
    public static readonly StringValue End = new StringValue("end");
    ...
    public static readonly StringValue ForRange = new StringValue("forrange");
