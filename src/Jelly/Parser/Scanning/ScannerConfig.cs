...
public class ScannerConfig : IScannerConfig
{
    ...
    {
        { "or", Operator.Or }, { "orelse", Operator.OrElse },
        { "and", Operator.And }, { "andthen", Operator.AndThen },
        { "not", Operator.Not },
        ...
        { "*", Operator.Multiply }, {"/", Operator.Divide }, {"//", Operator.FloorDivide },
        {"%", Operator.Modulo }, {"%%", Operator.FloorModulo },
        { "~", Operator.BitwiseNot },
        { "**", Operator.Exponent },
